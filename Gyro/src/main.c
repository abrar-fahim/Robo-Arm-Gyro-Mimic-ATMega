...
//        double qd = qz * 100;
        ...
        if(calibrationState == 0 && elapsedTime > 15) {
            ...
            dtostrf(roll1, 3, 0, itmp);uart_puts("r: "); uart_puts(itmp); uart_puts("   ");
            dtostrf(pitch1, 3, 0, itmp);uart_puts("p: "); uart_puts(itmp); uart_puts("   ");
            dtostrf(yaw1, 3, 0, itmp);uart_puts("y: "); uart_puts(itmp); uart_puts("   ");
